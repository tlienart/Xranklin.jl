...
For instance, if you decide to use PyPlot with Conda instead of the approach [suggested below](#pyplot_with_ga), information about the installation of miniconda will be shown to stdout for the first plot. This would ultimately appear on your site as well.
